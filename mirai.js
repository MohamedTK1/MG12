...
global.client = new Object({
  ...
  getTime: function (option) {
        switch (option) {
            case "seconds":
                return `${moment.tz("Africa/Cairo").format("ss")}`;
            case "minutes":
                return `${moment.tz("Africa/Cairo").format("mm")}`;
            case "hours":
                return `${moment.tz("Africa/Cairo").format("HH")}`;
            case "date": 
                return `${moment.tz("Africa/Cairo").format("DD")}`;
            case "month":
                return `${moment.tz("Africa/Cairo").format("MM")}`;
            case "year":
                return `${moment.tz("Africa/Cairo").format("YYYY")}`;
            case "fullHour":
                return `${moment.tz("Africa/Cairo").format("HH:mm:ss")}`;
            case "fullYear":
                return `${moment.tz("Africa/Cairo").format("DD/MM/YYYY")}`;
            case "fullTime":
                return `${moment.tz("Africa/Cairo").format("HH:mm:ss DD/MM/YYYY")}`;
        }
  }
});
...
chalkAnimation.rainbow('Information about me                                                 AkameBot\n⌯ Bot Mod By: Abdelrahman\n⌯ Run And Bot : Abdelrahman\n⌯ Facebook: Abdelrahman Elshamhout\n⌯ Gmail: ******@gmail.com');
