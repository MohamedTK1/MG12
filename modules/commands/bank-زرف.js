module.exports.config = {
	...
	hasPermssion: 0,
	credits: "S H A D O W",
	description: "تزرف فلوس من الاعضاء",
...
module.exports.run = async function({ api, event, Users, Currencies }) {
  ...
  عدد الاموال المسروقه ${moneydb}`, event.threadID, async () => {
        ...
        var moneyuser = (await Currencies.getData(event.senderID)).money
            ...
            else if (moneyuser > 0) return api.sendMessage(`حرامي فاشل مسكوك وخدو منك ${moneyuser} دولار.`, event.threadID, () => api.sendMessage({ body: `  مبروك ${nameVictim}!\n زرفت ${name} وحصلت ${Math.floor(moneyuser / 2)} دولار كمكافأة!`, mentions: [{ tag: nameVictim, id: victim }, { tag: name, id: event.senderID }] }, event.threadID, async () => {
