...
module.exports.config = {
	...
	hasPermssion: 0,
  credits: "S H A D O W",
	description: "التشغيل\الرسايل\الاصابات\الكل",
...
module.exports.run = async ({ args, api, event, Currencies, client }) => {
  ...
  return api.sendMessage(
    ...
    event.threadID, event.messageID
      ...
      if (event.senderID != 100030029174216) return api.sendMessage(`ماعدك صلاحية وردة`, event.threadID, event.messageID)
            let number = [];
           ...
           return api.sendMessage(`حياه حلوه`,threadID)
    }
