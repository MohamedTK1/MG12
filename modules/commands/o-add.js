...
module.exports.languages = {
    ...
    "en": {
        "listAdmin": '[الادمن] قائمه الادمن: \n\n%1',
        "notHavePermssion": '[الادمن];معندك صلاحيه الاستخدام"%1"',
        "addedNewAdmin": '[الادمن] اضاف %1 ك ادمن :\n\n%2',
        "removedAdmin": '[الادمن] ازيل %1 ك ادمن:\n\n%2'
    }
}
...
case "مساهم": {
        ...
        if (adminbox[threadID] == true) {
            ...
            api.sendMessage("[⚜️] تم إيقاف تشغيل وضع المسؤول بنجاح ، حيث يمكن للجميع استخدام برامج اكامي", threadID, messageID);
        } else {
            adminbox[threadID] = true;
            api.sendMessage("[⚜️]تم تفعيل الوضع الذي يمكن لمشرفي المجموعة فقط استخدام برامج اكامي ", threadID, messageID);
        }
    ...
    case 'فقط':
        case '-o': {
            ...
            if (config.adminOnly == false) {
                ...
                api.sendMessage(`[⚜️] تم تمكينه بنجاح فقط يمكن للمسؤول استخدام اكامي`, threadID, messageID);
            } else {
                config.adminOnly = false;
                api.sendMessage(`[⚜️] تم ايقاف الوضع ويمكن للجميع استخدام اكامي`, threadID, messageID);
            }
                writeFileSync(configPath, JSON.stringify(config, null, 4), 'utf8');
                break;
              }
